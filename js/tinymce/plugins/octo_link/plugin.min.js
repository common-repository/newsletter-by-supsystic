...
tinymce.PluginManager.add('octo_link', function(editor) {
	function renderLinkEditor() {
		...
		,	tagOut = '</div>';
		html += tagIn+ '<span class="mce-input-name-txt">link</span> <input id="' + editor.id + '_nbsPostLinkListField" type="text" name="href" value="">'+ tagOut;
		html += '<div style="display: none;" id="' + editor.id + 'nbsPostLinkList" class="nbsPostLinkList" data-postlink-to="#' + editor.id + '_nbsPostLinkListField"></div>';
	...
	function updateLinkWnd(e) {
		...
		if(!control._nbsInited) {
			...
			nbsInitCustomCheckRadio( linkWnd );
			control._nbsInited = true;
		}
		updateSelections(e);
		...
		nbsCheckUpdate( targetBlankCtrl );
	}
	...
	,	panel: {
		...
		,	onshow: function () {
			var fieldID = '#' + editor.id + '_nbsPostLinkListField',
				listID = '#' + editor.id + 'nbsPostLinkList',

<?php
abstract class viewNbs extends baseObjectNbs {
    /* 
     * @deprecated
     */
    protected $_tpl = NBS_DEFAULT;
    /*
	...
	public function getPath($tpl) {
		$path = '';
		$parentModule = frameNbs::_()->getModule( $this->_code );
	...
	public function getModel($code = '') {
		return frameNbs::_()->getModule( $this->_code )->getController()->getModel($code);
	}

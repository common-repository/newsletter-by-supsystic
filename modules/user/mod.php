<?php
class userNbs extends moduleNbs {
    ...
    public function isAdmin() {
        ...
        return current_user_can( frameNbs::_()->getModule('adminmenu')->getMainCap() );
    }
	...
	protected function _loadUserData() {
		if(!$this->_dataLoaded) {
			if(!function_exists('wp_get_current_user')) frameNbs::_()->loadPlugins();
	...
	public function getAdminsList() {
		global $wpdb;
		$admins = dbNbs::get('SELECT * FROM #__users 
